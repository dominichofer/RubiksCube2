...
public:
	...
	friend bool same_permutation(const EdgesCenter&, const EdgesCenter&);
	friend bool same_orientation(const EdgesCenter&, const EdgesCenter&);
	friend bool same_lr_slice_location(const EdgesCenter&, const EdgesCenter&);
	friend bool same_ud_slice_location(const EdgesCenter&, const EdgesCenter&);
	friend bool same_fb_slice_location(const EdgesCenter&, const EdgesCenter&);
};
